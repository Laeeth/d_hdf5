...
/* Name of tool */
enum  PROGRAMNAME ="h5ls";

enum  NAME_BUF_SIZE   =2048;
/*
...
static struct dispatch_t {
    const char *name;
    hid_t open function(hid_t loc, const char *name, hid_t apl_id);
    herr_t close function(hid_t obj);
    herr_t list1 function(hid_t obj);
    herr_t list2 function(hid_t obj, const char *name);
} dispatch_g[H5O_TYPE_NTYPES];

mixin template DISPATCH(TYPE, NAME, LIST1, LIST2)
{
