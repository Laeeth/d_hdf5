...
struct H5L
{
  ...
  auto get_info(hid_t loc_id, string name, hid_t lapl_id)
  {
    ...
    throwOnError(H5Lget_info(loc_id,toStringz(name),info,lapl_id));
    return *info;
  }
...
struct H5P
{
  ...
  {
    return H5Pget_filter2(plist_id,filter,flags/*out*/,cd_nelmts/*out*/,cd_values.ptr/*out*/,namelen,name.ptr,filter_config);
  }
  ...
  {
    throwOnError(H5Pget_filter_by_id2(plist_id,id,flags/*out*/,cd_nelmts/*out*/,cd_values.ptr/*out*/,namelen,name.ptr,filter_config));
  }
