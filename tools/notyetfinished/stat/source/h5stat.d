...
struct iter_t {
    ...
    ulong[H5S_MAX_RANK]  dset_rank_count;   /* Number of datasets of each rank */
    ...
    ulong[H5D_NLAYOUTS]  dset_layouts;           /* Type of storage for each dataset */
    ulong[H5_NFILTERS_IMPL]  dset_comptype; 	/* Number of currently implemented filters */
...
dataset_stats(iter_t *iter, const char *name, const H5O_info_t *oi)
{
    ...
    hsize_t[H5S_MAX_RANK]     dims;/* Dimensions of dataset */
 ...
 */
static int
parse_command_line(string[] args, handler_t **hand_ret)
{
    int                opt;
    uint            u;
    handler_t   *hand = NULL;
